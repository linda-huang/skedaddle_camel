...
let position_tests = [
  ...
  (* tile_to_pixel *)
  tile_to_pixel_test "origin" startpos (0, 0) (25, 25);
  tile_to_pixel_test "(1,1)" startpos (1, 1) (75, 75);
  tile_to_pixel_test "(0, 100)" startpos (0, 100) (25, 5025);
  (* pixel_to_tile *)
  pixel_to_tile_test "center origin (25, 25)" startpos (25, 25) (0, 0);
  pixel_to_tile_test "corner origin (0, 0)" startpos (0, 0) (0, 0);
  pixel_to_tile_test "edge origin (50, 0)" startpos (50, 0) (1, 0);
  pixel_to_tile_test "corner origin (50,50)" startpos (50, 50) (1,1);
]
(*******************************************************************
